  ...
  return (
    <section className="hero" id="hero">
      ...
      <div className="hero__left">
        ...
        {/* davaboi signature — the power move */}
        <div className="hero__alias-wrap">
          <span className="hero__alias">— {META.alias}</span>
        </div>
      ...
      <div className="hero__right">
        <span className="hero__num hero__num--tl">FULLSTACK · 2026</span>
        <span className="hero__num hero__num--tr">V — 1.0</span>
        <span className="hero__num hero__num--bl">{META.alias}</span>
        <span className="hero__num hero__num--br">IW_SYS</span>
